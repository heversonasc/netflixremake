...
import co.tiagoaguiar.netflixremake.util.MovieTesk

class MovieActivity : AppCompatActivity(), MovieTesk.Callback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val url = "https://api.tiagoaguiar.co/netflixapp/movie/$id?apiKey=a1cab02b-d194-4526-b52a-85da3b8f6534"
        MovieTesk(this).execute(url)
